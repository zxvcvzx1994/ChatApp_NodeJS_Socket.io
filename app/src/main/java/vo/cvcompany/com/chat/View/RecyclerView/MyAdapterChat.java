...
public class MyAdapterChat extends RecyclerView.Adapter<MyAdapterChat.MyViewHolder> {
    ...
    public MyAdapterChat(Context context, ArrayList<String> arrayList){
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new MyViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chat, parent, false));
    }
